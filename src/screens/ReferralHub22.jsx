          ...
          <div className="w-full">
            ...
            <div className="flex items-end justify-between w-full h-36 md:h-30">
              ...
              {[...Array(10)].map((_, i) => {
                ...
                return (
                  <div key={i} className="flex flex-col items-center flex-1">
                    ...
                    />
                    <span className="mt-1 text-[4px] md:text-[10px] text-gray-400">
                      Level {i + 1}
                    </span>
                  </div>
                );
              ...
              <div className="flex flex-col items-center flex-1">
                ...
                <span className="mt-1 text-[4px] md:text-[10px] text-gray-400">Level 11–15</span>
              </div>
              ...
              <div className="flex flex-col items-center flex-1">
                ...
                <span className="mt-1 text-[4px] md:text-[10px] text-gray-400">Level 16–20</span>
              </div>
            </div>
          </div>
...
<div className="flex flex-1 items-center justify-center gap-2 text-xs py-2">
  ...
  <span>Share on Whatsapp</span>
      ...
      {/* Bottom Table */}
   <div className="mt-6 rounded-xl border border-cyan-400/20 bg-[#05252a] p-4 sm:p-6">
  {/* Tabs */}
  <div className="flex flex-wrap gap-2 sm:gap-3 mb-4">
    {[
      ...
      <button
        key={i}
        className={`px-4 py-2 rounded-full text-xs sm:text-sm whitespace-nowrap ${
          i === 0
    ...
    <table className="w-full min-w-[700px] text-xs sm:text-sm">
      <thead className="text-gray-400 border-b border-white/10">
        <tr>
          ...
          <th className="py-3 px-2 text-left">Required Volume</th>
          <th className="py-3 px-2 text-left">Active Direct</th>
      ...
      <tbody>
        {[...Array(20)].map((_, i) => (
          <tr key={i} className="border-b border-white/5">
            <td className="py-3 px-2">Level {i + 1}</td>
