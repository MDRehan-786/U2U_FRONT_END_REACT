  ...
  return (
    <div className="min-h-screen text-white p-6">
      ...
      <div className="mb-6 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        {/* Title */}
        <div>
          <h1 className="text-xl font-semibold">Direct Bonus</h1>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-1 gap-3">
        ...
        <div className="xl:col-span-2 rounded-xl border border-[rgba(14,252,239,0.3)]  p-4">
          <h2 className="font-semibold mb-4">Direct Bonus</h2>
<div className="bg-white/[0.04] h-[2px] rounded-[10px] opacity-100 my-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mb-2">
            {[
              {
                label: "Direct Referrals", value:dashboardData?.total_direct, sub: "Total locked across all validators", svg: (
              ...
              {
                label: "Total Bonus", value:"$"+dashboardData?.direct_income.toFixed(4), sub: "Total locked across all validators", svg: (
           ...
           {
                label: "Total Stake", value:"$"+dashboardData?.total_investment.toFixed(4), sub: "Total locked across all validators", svg: (
               <svg
