  ...
  return (
    <div className="bg-gradient-to-br from-[#0F0F1D] via-[#102031] to-[#24BB79] rounded-lg px-4 py-6 flex gap-3 relative">
      <div className="flex flex-col gap-3">
        ...
        {show && (
          <div className="flex-1 flex flex-col sm:hidden gap-3 justify-center items-center">
            <button
              onClick={() => setIsModalOpen(true)}
              className="w-full bg-gradient-to-r font-semibold hover:text-black from-[#00D8FA] to-[#00FFA5] hover:from-[#00FFA5] hover:to-[#00D8FA] text-sm sm:text-base px-3 py-1.5 rounded-full cursor-pointer transition ease-in-out duration-300"
            >
              Transfer ${balanceRoi}
            </button>
 <select
              ...
              required
                className="w-full px-3 py-1 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-emerald-400"
              
           >
              <option  className="bg-[#0f172a] text-white"value="roi_wallet">Delegator Reward (${parseFloat(balanceRoi).toFixed(2)}) </option>
              <option  className="bg-[#0f172a] text-white" value="restake_wallet">Restake Wallet (${parseFloat(dashboardData?.user_wallet?.restake_wallet).toFixed(2)}) </option>
          ...
          />
            ...
            <button
              ...
              className="bg-gradient-to-r w-full md:w-1/2 lg:w-full font-semibold hover:text-black from-[#00D8FA] to-[#00FFA5] hover:from-[#00FFA5] hover:to-[#00D8FA] px-3 py-1.5 rounded-full cursor-pointer transition ease-in-out duration-300"
            >
              Reinvestment
            </button>
          </div>
