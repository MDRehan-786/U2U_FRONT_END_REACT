...
function ClaimReward({ balanceRoi,restake_wallet }) {
  ...
  const [restakeType, setrestakeType] = useState("roi_wallet");
...
return (
  <>
    ...
    <div className=" rounded-[10px] bg-[rgba(56,223,170,0.1)] grid grid-cols-1 md:grid-cols-4 gap-5 items-center justify-center py-5">
      ...
      <div className="flex items-center justify-center gap-2 text-md">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-sm text-[#9EB4AF] text-[12px] ">
      ...
      <div className="flex items-center justify-center gap-2 text-md">
        ...
        <div className="flex flex-col text-center">
          {" "}
          <span className="text-sm text-[#9EB4AF] text-[14px] ">
            Claimable
          </span>{" "}
          <span className="font-semibold text-base text-white text-[18px]">
            {" "}
            ${balanceRoi}
          </span>{" "}
      ...
      <div className="flex items-center justify-center gap-2 text-md w-full">
        {" "}
        <div className="flex flex-col items-center justify-center text-center w-full">
          {" "}
          <button
            className="w-3/4 inline-flex items-center justify-center gap-2 px-5 py-1 text-[#38DFAA] font-semibold text-[14px] leading-[18px] bg-[#38DFAA]/5 border border-[#38DFAA] rounded-[100px] transition-all duration-200 ease-in-out hover:bg-[rgba(255,255,255,0.18)] hover:text-white hover:shadow-md focus:outline-none"
    ...
    <select
              value={restakeType}
              onChange={(e) => setrestakeType(e.target.value)}
              required
                className="w-3/4 px-3 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-emerald-400"
              
           >
              <option  className="bg-[#0f172a] text-white"value="roi_wallet">Claimable Roi</option>
              <option  className="bg-[#0f172a] text-white" value="restake_wallet">Restake Wallet</option>
          ...
          />{" "}
          <button
            className="w-3/4 inline-flex items-center justify-center gap-2 px-5 py-2 text-[#38DFAA] font-semibold text-[14px] leading-[18px] bg-[#38DFAA]/5 border border-[#38DFAA] rounded-full transition-all duration-200 ease-in-out hover:bg-[rgba(255,255,255,0.18)] hover:text-white hover:shadow-md focus:outline-none"
