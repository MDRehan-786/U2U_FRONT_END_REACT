      ...
      <div className="md:col-span-12 text-sm leading-4 ">
        ...
        shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
            <div className="flex items-center gap-2 border-b border-[#334038] pb-2 font-bold">
              <RiCoinFill className="text-gray-300" /> 2X Earnings Progress
            </div>
            <div className="py-3 flex gap-3 sm:flex-row flex-col">
              <div className="text-sm flex flex-col gap-5">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {parseFloat(dashboardData?.stake).toFixed(4)}
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  <SiLevelsdotfyi className="text-stone-400" />
                  Earned Daily Reward - $ {dashboardData?.daily_profit.toFixed(4)}
                </div>

                <div className="flex items-center gap-2">
                  <SiVirustotal className="text-red-400" />
